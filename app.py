...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 15 16:40:49 2023
...
req = requests.post('https://oc-p7-api-flask-8e5e1aa12eb3.herokuapp.com/reponse', json = {"Identifiant" : str(id_first)})  #sur Heroku
...
if id_filter==None:
    ...
    req = requests.post('https://oc-p7-api-flask-8e5e1aa12eb3.herokuapp.com/reponse', json = {"Identifiant" : str(id_filter)})  #sur Heroku
    temp = req.json()
    result = str(temp["Réponse"])
    #Scores du client
    seuil = str(((1-0.535)*100))
    ...
    with outer_cols[1]:
        ...
        req = requests.post('https://oc-p7-api-flask-8e5e1aa12eb3.herokuapp.com/data_customer/', json = {"Identifiant" : str(id_filter)})  #sur Heroku
        info = req.json()['data']
